    ...
    <div class="menu-wrap">
        <div class="menu-sidebar">
            <ul class="menu nolist">';
                if($_SESSION['id']) {
                    echo '<li><a href="../enroll/"><img src="../images/pencil-64.png" alt="Enroll" class="menu-icon"></a> <a href="../enroll" class="line">Enroll</a></li>';
                }
                echo '<li><a href="../course/"><img src="../images/notebook-56.png" alt="Course" class="menu-icon"></a> <a href="../course" class="line">Course</a></li>';
                if($_SESSION['id']) {
                    echo '<li><a href="../grade/"><img src="../images/checklist-56.png" alt="Progress" class="menu-icon"></a> <a href="../grade" class="line">Progress</a></li>';
                ...
                echo 
                '<li><a href="../about"><img src="../images/info-56.png" alt="About" class="menu-icon"></a> <a href="../about" class="line">About</a></li>
                </ul>
            </div>
        </div>
    </header>';
